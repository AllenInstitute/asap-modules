...
def test_pt_match_opts_module(render, pt_match_input_stack, tilepair_file, tmpdir_factory):
    ...
    mod = PtMatchOptimization(input_data=pt_match_opts_example, args=['--output_json', out_json])
    mod.run()
