...
```JSON
{
    ...
    "properties": {
        ...
        "outfile": {
            "type": "string",
            "description": "File to which json output of lens correction (leaf TransformSpec) is written"
        },
        "project_path": {
            "type": "string",
        ...
        "processing_directory": {
            "x-nullable": true,
            "type": "string",
            "description": "directory to which trakem2 processing directory will be written (will place in project_path directory if unspecified or create temporary directory if None)"
        },
        "heap_size": {
            "default": 20,
            "type": "integer",
